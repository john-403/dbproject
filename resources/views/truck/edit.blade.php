...
<body>
    ...
    <h1 class="ms-5">Edit Truck:</h1>

    <form action="{{ route('trucks.update', $truck) }}" method="POST" enctype="multipart/form-data" class="ms-5 me-5 w-50">
        @csrf
        @method('PATCH')
        {{-- <div class="row">
            <div class="col-6">
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" id="brand" name="brand" value="{{ $truck->brand }}">
          </div>
          <div class="form-group mb-3">
          ...
          <div class="form-group mb-3">
              <label for="maxLoad">Max Load</label>
                <input type="number" class="form-control" id="maxLoad" name="maxLoad" value="{{$truck->maxLoad  }}">
              </div>
          <div class="form-group mb-3">
              <label for="height">Height</label>
                <input type="number" class="form-control" id="height" name="height" value="{{ $truck->height }}">
              </div>

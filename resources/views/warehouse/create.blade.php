...
<body>
    <h1 class="ms-5">Add Warehouse</h1>

    <form action="{{ route('warehouses.store') }}" method="POST" enctype="multipart/form-data" class="ms-5 me-5 w-50">
        @csrf
        {{-- <div class="row">
            <div class="col-6">
                <p>Hello</p>
        ...
        <div class="form-group mb-3">
            ...
            <input type="number" class="form-control" id="size" name="size" placeholder="5000 m2">
          </div>
          <div class="form-group mb-3">
          <label for="floors">Floors</label>
            <input type="number" class="form-control" id="floors" name="floors" placeholder="2 Floors">
          </div>
          <div class="form-group mb-3">
              <label for="type">Type</label>
                <input type="text" class="form-control" id="type" name="type" placeholder="Consumable">
              </div>

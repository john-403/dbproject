...
<body>
    ...
    <h1 class="ms-5">Edit Warehouse:</h1>

    <form action="{{ route('warehouses.update', $warehouse) }}" method="POST" enctype="multipart/form-data" class="ms-5 me-5 w-50">
        @csrf
        @method('PATCH')
        {{-- <div class="row">
            <div class="col-6">
        ...
        <div class="form-group mb-3">
            ...
            <input type="number" class="form-control" id="size" name="size" value="{{ $warehouse->size }}">
          </div>
          <div class="form-group mb-3">
          <label for="floors">Floors</label>
            <input type="number" class="form-control" id="floors" name="floors" value="{{ $warehouse-> floors }}">
          </div>
          <div class="form-group mb-3">
              <label for="type">Type</label>
                <input type="text" class="form-control" id="type" name="type" value="{{ $warehouse-> type}}">
              </div>

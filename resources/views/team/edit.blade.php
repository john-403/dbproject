...
<body>
    ...
    <h1 class="ms-5">Edit Team:</h1>

    <form action="{{ route('teams.update', $team) }}" method="POST" enctype="multipart/form-data" class="ms-5 me-5 w-50">
        @csrf
        @method('PATCH')
        {{-- <div class="row">
            <div class="col-6">
        ...
        <div class="form-group mb-3">
            ...
            <input type="number" class="form-control" id="inputsize" name="size" value="{{ $team->size }}">
          </div>
          <div class="form-group mb-3">
          <label for="inputleader">Leader</label>
            <input type="text" class="form-control" id="inputleader" name="leader" value="{{ $team->leader }}">
          </div>
          <div class="form-group mb-3">
              <label for="task">Task</label>
                <input type="text" class="form-control" id="task" name="task" value="{{$team->task  }}">
              </div>
          <div class="form-group mb-3">
              <label for="equiment">Equipment</label>
                <input type="text" class="form-control" id="equiment" name="equipment" value="{{ $team->equipment }}">
              </div>

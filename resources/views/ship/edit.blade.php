...
<body>
    ...
    <h1 class="ms-5">Edit Ship:</h1>

    <form action="{{ route('ships.update', $ship) }}" method="POST" enctype="multipart/form-data" class="ms-5 me-5 w-50">
        @csrf
        @method('PATCH')
        {{-- <div class="row">
            <div class="col-6">
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" id="inputcountry" name="country" value="{{ $ship->country }}">
          </div>
          <div class="form-group mb-3">
          <label for="inputowner">Owner</label>
            <input type="text" class="form-control" id="inputowner" name="owner" value="{{ $ship->owner }}">
          </div>
          <div class="form-group mb-3">
              <label for="inputsize">Size</label>
                <input type="number" class="form-control" id="inputsize" name="size" value="{{ $ship->size }}">
              </div>
          <div class="form-group mb-3">
              <label for="inputmaxQuantity">Max Quantity</label>
                <input type="number" class="form-control" id="inputmaxQuantity" name="maxQuantity" value="{{ $ship->maxQuantity }}">
              </div>
          <div class="form-group mb-3">
            <label for="inputproductType">Product Type</label>
            <input type="text" class="form-control" id="inputproductType" name="productType" value="{{ $ship->productType }}">
          </div>

...
<body>
    <h1 class="ms-5">Add Dock</h1>

    <form action="{{ route('docks.store') }}" method="POST" enctype="multipart/form-data" class="ms-5 me-5 w-50">
        @csrf
        {{-- <div class="row">
            <div class="col-6">
                <p>Hello</p>
        ...
        <label for="inputsize">Size in m<sup>2</sup></label>
          <input type="number" class="form-control" id="inputheight" name="size" placeholder="height">
        </div>
        <div class="form-group mb-3">
